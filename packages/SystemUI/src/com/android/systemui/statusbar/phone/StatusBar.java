...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mStreakSettingsObserver.observe();
        mStreakSettingsObserver.update();
...
*/
    ...
    private StreakSettingsObserver mStreakSettingsObserver = new StreakSettingsObserver(mHandler);
    private class StreakSettingsObserver extends ContentObserver {
        StreakSettingsObserver(Handler handler) {
            super(handler);
        }
