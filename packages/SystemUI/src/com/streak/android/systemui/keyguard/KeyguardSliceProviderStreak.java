package com.streak.android.systemui.keyguard;
...
public class KeyguardSliceProviderStreak extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderStreak> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderStreak keyguardSliceProviderStreak, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderStreak);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderStreak.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderStreak keyguardSliceProviderStreak;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderStreak = (KeyguardSliceProviderStreak) mProviderReference.get();
            }
            if (keyguardSliceProviderStreak != null) {
                keyguardSliceProviderStreak.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderStreak#onBindSlice");
        Slice slice;
